...
def test_evaluation_pipeline_produces_valid_posterior(
    ...
    from darksiren_emri.plotting import apply_style, save_figure
    from darksiren_emri.plotting.bayesian_plots import plot_event_posteriors
...
def test_posterior_narrows_with_more_detections(
    ...
    from darksiren_emri.bayesian_inference.bayesian_statistics import BayesianStatistics
    from darksiren_emri_test.integration.conftest import (
    ...
    from darksiren_emri.plotting import save_figure
