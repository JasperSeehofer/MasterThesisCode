...
PHYSICS_CHANGE_THETA_HOOK_20260828.md (author-approved, ledger row #216):
θ = (b, s) reparametrizes the host-z kernel at sites 2.1/2.2/2.3 as
``z̃ = z + b(1+z)``, ``σ̃_eff = s·σ_eff`` (b applied AFTER the peculiar-velocity
width fold — the registered pin), with a literal skip at θ = (0, 1) (GATE T-ID).
