...
from darksiren_emri.plotting import apply_style, get_figure
from darksiren_emri.plotting._helpers import _fig_from_ax, compute_credible_interval
...
def test_fig_from_ax_importable_from_helpers() -> None:
    ...
    from darksiren_emri.plotting._helpers import _fig_from_ax as fn
