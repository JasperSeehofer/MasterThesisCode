"""Tests for darksiren_emri.analysis.parse_host_counts."""
...
from darksiren_emri.analysis.parse_host_counts import (
    _HOST_COUNT_RE,
...
class TestBuildHostCountCSV:
    def test_writes_csv_to_default_path(self, tmp_path: Path) -> None:
        pairs = [(58, 34), (376, 138)]
        # Layout: data_dir/logs/darksiren_emri_*_h_0_73.log (mirror of cluster sync)
        log_dir = tmp_path / "logs"
        log_dir.mkdir()
        _make_log(log_dir, "darksiren_emri_20260506_141633_h_0_73.log", pairs)
    ...
    def test_raises_when_logs_have_no_host_counts(self, tmp_path: Path) -> None:
        ...
        (tmp_path / "darksiren_emri_20260515_h_0_73.log").write_text(
    ...
    def test_h_value_filter(self, tmp_path: Path) -> None:
        log_dir = tmp_path / "logs"
        log_dir.mkdir()
        _make_log(log_dir, "darksiren_emri_h_0_73.log", [(58, 34)])
        _make_log(log_dir, "darksiren_emri_h_0_65.log", [(99, 99)])
