...
try:
    import darksiren_emri.parameter_estimation.parameter_estimation as pe_module
    from darksiren_emri.parameter_estimation.parameter_estimation import ParameterEstimation
...
def test_psd_cache_returns_same_array_for_same_n() -> None:
    ...
    from darksiren_emri.constants import ESA_TDI_CHANNELS
    from darksiren_emri.LISA_configuration import LisaTdiConfiguration
...
class TestCRBSafety:
    ...
    def test_ill_conditioned_fisher_raises(self, tmp_path: pathlib.Path) -> None:
        ...
        from darksiren_emri.exceptions import ParameterEstimationError
...
def test_alarm_timeout_is_90_seconds() -> None:
    ...
    source = pathlib.Path("darksiren_emri/main.py").read_text()
...
def test_dead_freq_crop_helper_is_removed() -> None:
    ...
    matches across darksiren_emri/ and darksiren_emri_test/.
    """
