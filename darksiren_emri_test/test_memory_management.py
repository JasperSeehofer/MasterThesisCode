...
def test_cpu_import() -> None:
    ...
    from darksiren_emri.memory_management import MemoryManagement as MemMgmt

    assert MemMgmt is not None


@patch("darksiren_emri.memory_management._GPUTIL_AVAILABLE", False)
@patch("darksiren_emri.memory_management.GPUtil", None)
@patch("darksiren_emri.memory_management._CUPY_AVAILABLE", False)
@patch("darksiren_emri.memory_management.cp", None)
