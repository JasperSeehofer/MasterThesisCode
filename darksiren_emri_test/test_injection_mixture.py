...
from darksiren_emri.arguments import Arguments, _parse_arguments
...
from darksiren_emri.main import injection_campaign
...
def _run_campaign(
    ...
    *,
    ...
    monkeypatch.setattr("darksiren_emri.constants.INJECTION_CSV_PATH", csv_template)
    monkeypatch.setattr(
        "darksiren_emri.parameter_estimation.parameter_estimation.ParameterEstimation",
