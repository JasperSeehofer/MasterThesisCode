...
[Eq.~\eqref{eq:pitfall:sigmaglobal}, reproduced here for convenience
with its redshift cutoff explicit],
\begin{equation}
  \Sigma_{\mathrm{global}}(h) \;=\;
...
\begin{equation}
  \Sigma_{\mathrm{global}}(h) \;\approx\; C\,\beta_G(h),
  \qquad
...
$\Sigma_{\mathrm{global}}(h)/\beta_G(h)$ on $14$ values of $h$ in
...
$\bar n_{\mathrm{gal}}(h) \propto 1/V_\mathrm{c} \propto h^3$, and
...
evaluate $\Sigma_{\mathrm{global}}$ (their $L_{\mathrm{cat}}$ is a local
