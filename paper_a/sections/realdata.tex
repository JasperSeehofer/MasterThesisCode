...
The selection function $p_\mathrm{det}$ is estimated from a dedicated injection campaign of $72\,000$ events at $h = 0.73$, binned in six equal-$|\sin\beta|$ sky bands; all 3355 analysis events fall inside the resulting $p_\mathrm{det}$ grid. % src: results/commission_20260701/redteam/crux_realdata.md
