...
published equation.  Restricting the numerator sum to the
localization set $\mathcal{G}_i$ is numerically inert, since the measurement Gaussian
...
\citealt{Gray:2021sew}], but eq.~A17
