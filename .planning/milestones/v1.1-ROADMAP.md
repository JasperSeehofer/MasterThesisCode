...
- [x] **Phase 6: Data Cleanup** - Delete stale outputs and prevent future tracking of generated files — completed 2026-03-27
- [x] **Phase 7: Cluster Access** - Establish SSH connectivity and verify cluster environment readiness — completed 2026-03-28
- [x] **Phase 8: Simulation Campaign** - Run test simulation, evaluate H0 posterior, and validate results — completed 2026-03-29
...
Plans:
- [x] 08-01-PLAN.md — Fix CWD in sbatch scripts, push to cluster, submit smoke-test pipeline (3 tasks, 10 steps, seed 100)
- [x] 08-02-PLAN.md — Monitor pipeline completion, validate results (SNR, detection rate, H0 posterior), rsync to local
