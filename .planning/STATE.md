...
Last activity: 2026-07-11 — Completed quick task 260711-iic (N-4 shallow-venue regime): the seed600 shallow 1D +0.0132 is ESTIMATOR-INTRINSIC — a σ_z/z-at-low-z truncated-volume-kernel Eddington effect (venue depth ladder: calibrated at z_med 0.28, +0.030 at z_med 0.044; vanishes at σ_z≤0.015); seed600 jackknife confirms it is broad/systematic, not outlier-driven. Full seed600 attribution needs its low-z σ_z model; cross-seed needs the campaign. (Prior: 260711-hx1 floor decomposition COMPLETE — H_σ noise-model confirmed.)
