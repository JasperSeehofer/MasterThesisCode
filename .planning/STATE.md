...
Last activity: 2026-07-11 — Completed quick task 260711-hx1: σ(dL_obs)-vs-σ(dL_true) noise-model floor probe. H_σ CONFIRMED — floor decomposition COMPLETE: model-σ + p_det-inside removes ~85–90% of the floor (both regimes, cov68 nominal at campaign n); const-σ floor is a real asymptotic bias (flat in n, cov68 collapses); tiny 2nd-order residual ≈15× below σ_boot. Practically subdominant for Paper B
