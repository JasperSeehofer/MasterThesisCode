...
Artifacts: `.planning/gate/G7row9_eddington_m_impact_postDgfix.json` (this run) vs
`.planning/gate/G7row9_eddington_m_impact.json` (pre-fix, superseded — see caveat 1).
