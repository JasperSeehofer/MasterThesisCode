...
from darksiren_emri.constants import SNR_THRESHOLD, H
...
from darksiren_emri.plotting._helpers import compute_credible_interval, get_figure
...
def _load_combined_posterior(variant: str, data_dir: Path) -> dict[str, Any]:
    ...
    :func:`darksiren_emri.plotting._helpers.load_canonical_combined_posterior`
...
def plot_closure_test_overlay(
    ...
    *,
    ...
    if ax is None:
        ...
        from darksiren_emri.plotting._helpers import _fig_from_ax
