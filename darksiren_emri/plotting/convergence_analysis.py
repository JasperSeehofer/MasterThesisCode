...
from darksiren_emri.plotting._metrics import (
    bias_pct,
...
def compute_m_z_improvement_bank(
    ...
    *,
    ...
    metrics defined in :mod:`darksiren_emri.plotting._metrics`.
...
def plot_m_z_improvement_panels(
    ...
    * (2,3): Summary text — counts, median reduction, MAP recovery, etc.
    ...
    host_counts:
        DataFrame from
        :func:`darksiren_emri.analysis.parse_host_counts.parse_host_counts`
