...
from darksiren_emri.decorators import timer_decorator
from darksiren_emri.exceptions import (
    ParameterEstimationError,
    ParameterOutOfBoundsError,
)
from darksiren_emri.LISA_configuration import LisaTdiConfiguration
from darksiren_emri.waveform_generator import (
    WaveGeneratorType,
...
class ParameterEstimation:
    ...
    def scalar_product_of_functions(
        ...
        noise PSD from :meth:`~darksiren_emri.LISA_configuration.LisaTdiConfiguration.power_spectral_density`.
    ...
    def save_cramer_rao_bound(
        ...
        # population (darksiren_emri.dark_siren_injection). Recorded so the
