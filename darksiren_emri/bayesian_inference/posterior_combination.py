...
def combine_posteriors(
    ...
    d_h_table : dict[float, float] or None
        ...
        :func:`~darksiren_emri.bayesian_inference.bayesian_statistics.precompute_completion_denominator`.
    ...
    if d_h_table is None:
        ...
        from darksiren_emri.bayesian_inference.bayesian_statistics import (  # noqa: PLC0415
            precompute_completion_denominator,
        )
        from darksiren_emri.bayesian_inference.simulation_detection_probability import (  # noqa: PLC0415
            SimulationDetectionProbability,
        )
        from darksiren_emri.constants import (  # noqa: PLC0415
            HOST_DRAW_Z_MAX,
            INJECTION_DATA_DIR,
            OMEGA_DE,
            OMEGA_M,
