...
:mod:`darksiren_emri.bayesian_inference.bayesian_statistics`
(:class:`~darksiren_emri.bayesian_inference.bayesian_statistics.BayesianStatistics`)
...
from darksiren_emri.datamodels.parameter_space import (
    Parameter,
    ParameterSpace,
    uniform,
)
...
from darksiren_emri.M1_model_extracted_data.detection_fraction import (
    DetectionFraction,
)
...
#   darksiren_emri.bayesian_inference.bayesian_statistics
