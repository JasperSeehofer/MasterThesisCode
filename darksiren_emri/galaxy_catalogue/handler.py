...
from darksiren_emri.physical_relations import dist

_LOGGER = logging.getLogger()
REDUCED_CATALOGUE_FILE_PATH = "./darksiren_emri/galaxy_catalogue/reduced_galaxy_catalogue.csv"
    ...
    def from_attributes(
        ...
        Args:
            ...
            catalog_index: Catalog row index. Use ``-1`` to flag an
                ...
                (see :mod:`darksiren_emri.dark_siren_injection`). Defaults
...
class GalaxyCatalogueHandler:
            ...
            try:
                ...
                try:
                    self.parse_to_reduced_catalog(
                        galaxy_catalogue_file_path="./darksiren_emri/galaxy_catalogue/GLADE+.txt"
                    )
                    self.reduced_galaxy_catalog = self.read_reduced_galaxy_catalog()
    ...
    def get_possible_hosts_from_ball_tree(
        ...
        References:
            ...
            darksiren_emri/datamodels/detection.py:15-40 (_sky_localization_uncertainty).
        """
        # Eq. (standard spherical polar); COORD-02 fix per .planning/phases/36-coordinate-frame-fix/36-CONTEXT.md D-17
    ...
    def draw_uniform_hosts(
        ...
        Args:
            ...
            z_max: Exclusive upper redshift bound for eligible hosts. Defaults to
                :data:`~darksiren_emri.constants.HOST_DRAW_Z_MAX`.
    ...
    def draw_rate_weighted_hosts(
        ...
        (:func:`darksiren_emri.emri_rate.R_eff_per_mbh`; Babak et al. 2017,
        ...
        comoving volume density :func:`~darksiren_emri.emri_rate.R_EMRI`) is
