...
$\lesssim 2.1\%$ to $\lesssim 2.0\%$ precision in the
completeness-corrected production run (upper bounds limited by
$h$-grid resolution; the thesis baseline without completeness
correction gave $\sim 4\%$ and $\sim 1.8\%$, respectively).
The mechanism is
