...
| *(in progress)* | post-H3 h=0.73 closure validation (job 4250797) | `f01595c` | 21-pt fine | 1473 | — | — | cpu_il, 7-task array. Gate G_H3b: 2D z ≤ 2σ AND 2D bias ≤ 1D bias. |
| *(in progress)* | post-H3 Phase 45 412-event regression (job 4250798) | `f01595c` | 21-pt fine | 412 | — | — | dev_cpu_il, 4-task array. Gate: 2D z ≤ 2σ. Also clears bridge fix's pending Phase 45 re-validation. |
