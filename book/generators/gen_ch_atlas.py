...
``book/site/data/atlas_curves.json``
    ...
    1. ``psd`` — REAL. ``LisaTdiConfiguration.power_spectral_density_a_channel``
       (``darksiren_emri/LISA_configuration.py``), A-channel PSD with and
...
from darksiren_emri.constants import LISA_MISSION_DURATION_YEARS  # noqa: E402
from darksiren_emri.galaxy_catalogue import handler as _rv_handler  # noqa: E402
from darksiren_emri.LISA_configuration import LisaTdiConfiguration  # noqa: E402
from darksiren_emri.physical_relations import (  # noqa: E402
    comoving_volume_element,
    dist,
)
from darksiren_emri.validation.pp_coverage import (  # noqa: E402
    D50_GPC,
    W_PDET_GPC,
...
def build_zkernel() -> dict[str, Any]:
    from darksiren_emri.constants import OMEGA_DE, OMEGA_M
    from darksiren_emri.constants import H as H_TRUE
