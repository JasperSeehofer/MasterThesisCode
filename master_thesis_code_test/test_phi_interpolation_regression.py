...
from master_thesis_code.dark_siren_injection import dark_mass_log10_density_unnormalised
from master_thesis_code.emri_rate import duty_cycle_Gamma, kappa_cap
...
def test_patch_seam_tracks_the_underlying_density(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    :func:`~master_thesis_code.bayesian_inference.bayesian_statistics.
