...
from master_thesis_code.constants import LISA_MISSION_DURATION_YEARS
...
def test_plunge_window_draw_roundtrip() -> None:
    ...
    from master_thesis_code.plunge_window import (
        _get_trajectory,
...
def test_plunge_window_high_mass_p0_below_10() -> None:
    ...
    from master_thesis_code.plunge_window import draw_plunge_window_initial_conditions
