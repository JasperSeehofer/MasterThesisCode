...
def _deterministic_1d_numerator() -> npt.NDArray[np.float64]:
    ...
    from master_thesis_code_test.bayesian_inference.test_kernel_parity import (  # noqa: PLC0415
...
def test_R1_generator_marginal_assembly_uses_legacy_tables() -> None:
    ...
    from master_thesis_code_test.test_generator_marginal_mode import (  # noqa: PLC0415
        _run_p_Di_gen,
    )
