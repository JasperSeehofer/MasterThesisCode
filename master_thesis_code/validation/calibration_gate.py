...
* :mod:`master_thesis_code.validation.closed_loop_gfrac` (registered
...
* :mod:`master_thesis_code.validation.pp_coverage` supplies the HPD
  ...
  ``master_thesis_code_test/validation/test_calibration_gate.py`` (V2)).
...
def to_closed_loop_config(gcfg: GateConfig) -> cl.ClosedLoopConfig:
    ...
    Returns:
        The equivalent :class:`~master_thesis_code.validation.closed_loop_gfrac.ClosedLoopConfig`.
    """
...
class GateContext:
    ...
    Wraps the parent's :class:`~master_thesis_code.validation.closed_loop_gfrac.ClosedLoopContext`
...
def run_validate(workers: int) -> dict[str, Any]:
    ...
    out["v2"] = {
        "note": (
            "run: uv run pytest master_thesis_code_test/validation/"
