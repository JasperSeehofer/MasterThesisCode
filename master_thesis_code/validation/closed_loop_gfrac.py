...
**Why it is a separate module from** :mod:`master_thesis_code.validation.pp_coverage`.
...
===========================================================  ==================================
:func:`~master_thesis_code.bayesian_inference.bayesian_statistics.dark_mass_density_per_mass`
...
:func:`~master_thesis_code.bayesian_inference.bayesian_statistics.completion_mass_factor_g`
                                                              ...
                                                              **recomputed at every h**
                                                              (A3(i): never frozen)
:func:`~master_thesis_code.bayesian_inference.bayesian_statistics.precompute_phi_marginal_survival`
...
``SimulationDetectionProbability.detection_probability_with_bh_mass_interpolated``
                                                              ...
                                                              horizon survival)
:func:`~master_thesis_code.physical_relations.dist_vectorized`,
:func:`~master_thesis_code.physical_relations.comoving_volume_element`
                                                              flat-LCDM ladder and
                                                              ``w_pop = dV_c/dz /(1+z)``
``_HOST_QUAD_N`` (50), ``_G_I_HERMITE_NODES`` (64)             identical quadrature convention
===========================================================  ==================================

It does **not** call :class:`~master_thesis_code.bayesian_inference.bayesian_statistics.BayesianStatistics`
